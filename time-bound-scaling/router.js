var authhelper = require('./auth/authhelper.js'),logger=require('./logger.js').logger;
...
app.get('/ec2', function(req,res){
  res.render('ec2', { title:"RAWS" ,user: req.user });

});

app.get('/ec2/getSecurityGroups',function(req,res){
     ec2.getSecurityGroups(res);
